...
name: email-triage
description: >
  Triage Andrew's Gmail inbox into a two-axis urgency × context report — read-only,
  never touches labels, archive state, drafts, or sends.
argument-hint: "[scope, e.g. 7d | 30d | all]"
---
