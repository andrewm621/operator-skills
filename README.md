...
36 custom skills that turn Claude into a full operating system for software projects. Not demos — the actual commands I use daily to run 50+ projects across Next.js, Vite, Cloudflare Workers, and Turborepo monorepos.
...
Claude runs the commands for you. Type `/` to see all 36 skills in autocomplete.
...
Type `/` in a new session to see all 36 skills.
...
| Skill | What it does | Example |
|-------|-------------|---------|
| `/ship` | Release end-to-end — pre-flight, verify, version bump, changelog, tag, deploy | `/ship minor` |
