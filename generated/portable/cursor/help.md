...
Arguments: {the text you type after the command} (optional: category name to filter, or "all" for full list)
...
═══════════════════════════════════════════════════════════════
 ...
 /email-triage [scope]    Triage Gmail into NEEDS YOU/WAITING/FYI/NOISE — report only
...
If `{the text you type after the command}` names a specific skill (e.g., `/help migrate`), show its full description by reading `~/.claude/commands/<skill>.md` and presenting a summary.
