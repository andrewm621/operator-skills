...
Arguments: {the text you type after the command} (subcommand: "audit", "update", "align", "check <package>", "outdated", or a package name to investigate)

## Steps

1. **Parse the subcommand** — From `{the text you type after the command}`:
