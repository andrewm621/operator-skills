...
Subject: {the text you type after the command} (a feature, workflow, system, codebase area, or business process)

## Steps

1. **Parse the subject** — From `{the text you type after the command}`, determine:
