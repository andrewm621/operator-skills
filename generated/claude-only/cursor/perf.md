...
Arguments: {the text you type after the command} (optional: URL, "bundle", "vitals", or a specific area like "images", "fonts", "js")

## Steps

1. **Parse the request** — From `{the text you type after the command}`:
